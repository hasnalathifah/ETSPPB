...
@Composable
fun TransferAntarBank(navController: NavController) {
...
//        )
        ...
        Text(text = "Transfer Antar Bank", fontSize = 28.sp, fontWeight = FontWeight.Bold)

        Spacer(modifier = Modifier.height(16.dp))
        OutlinedTextField(value = namaBank, modifier = Modifier.fillMaxWidth(), onValueChange = { namaBank = it }, label = {
            Text(text = "Masukkan nama bank")
        })
        ...
        Spacer(modifier = Modifier.height(16.dp))
        Button(onClick = { tfAntarBankHandler(navController,namaBank, norekTujuan, nominal, keterangan) },
